...
This repository contains a robust Deep Learning pipeline designed to detect, segment, and crop individual payment slips from a composite image. Developed as part of a Deep Learning quiz, this tool handles complex scenarios including variable lighting, scanner margins, and vertically stacked receipts.
...
3.  **Run the Pipeline**:
    ...
    ```bash
    python Deep_Learning_QUIZ_2.py
    ```
